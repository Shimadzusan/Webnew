...
//////////////////////////////////MAIN_MODUL/////////////////////////////////////////////////////////////
	...
	boolean names = false; boolean number = false;
	Clever clever = new Clever();
		clever.getReport(comment, names,  number);
		...
		String part_three = clever.getReport(comment, names,  number) + "<! Конец генерируемой html-части><p>Copyright icon</p></body></html>";
